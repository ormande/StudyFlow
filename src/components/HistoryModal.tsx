...
export default function HistoryModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-[70] flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-lg max-h-[85vh] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200 transition-colors flex flex-col">
