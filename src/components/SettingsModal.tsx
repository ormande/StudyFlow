import { X, Instagram, AlertTriangle, Moon, Sun, Download, Upload, Target, Settings, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-xs md:max-w-2xl max-h-[90vh] flex flex-col shadow-2xl animate-in zoom-in-95 duration-200 transition-colors">
        ...
        <div className="p-6 overflow-y-auto">
            ...
            <div className="space-y-6">
                ...
                <div className="text-center md:text-left pb-4 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-xl font-bold shadow-md transition-all flex items-center justify-center gap-2 text-white active:scale-95 ${
                      isDarkMode ? 'bg-amber-500 hover:bg-amber-600' : 'bg-indigo-500 hover:bg-indigo-600'
                    }`}
                  >
                ...
                <div className="text-center md:text-left pb-4 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <div className="mb-3 flex items-baseline justify-center md:justify-start gap-1">
                    <span className="text-3xl font-black text-gray-800 dark:text-white">{Math.floor(dailyGoal / 60)}h</span>
                ...
                <div className="text-center md:text-left pb-4 border-b border-gray-100 dark:border-gray-700 md:border-none">
                  <p className="text-xs text-gray-400 uppercase font-bold mb-3">Privacidade</p>
                  <button
                    onClick={onTogglePerformance}
                    className={`w-full py-3 rounded-xl font-bold shadow-md transition-all flex items-center justify-center gap-2 text-white active:scale-95 ${
                      showPerformance ? 'bg-teal-500 hover:bg-teal-600' : 'bg-gray-400 hover:bg-gray-500'
                    }`}
                  >
                  ...
                  <p className="text-[10px] text-gray-400 mt-2 text-center md:text-left">
                    Mostrar acertos/erros ao compartilhar?
                  </p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                <div className="text-center md:text-left pb-4 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <div className="space-y-3">
                    <button onClick={handleExport} className="w-full py-3 rounded-xl font-bold shadow-md transition-all flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white active:scale-95">
                      <Download size={18} /> Exportar Backup
                    </button>
                    <button onClick={handleImportClick} className="w-full py-3 rounded-xl font-bold shadow-md transition-all flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white active:scale-95">
                      <Upload size={18} /> Importar Backup
                    </button>
                    <input ref={fileInputRef} type="file" accept=".json" onChange={handleFileChange} className="hidden" />
                  </div>
                  <p className="text-[10px] text-gray-400 mt-2 text-center md:text-left">Use para backup ou trocar de dispositivo</p>
                </div>
          ...
          <div className="text-center mt-8 pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            <p className="text-[10px] text-gray-400 mt-2">Versão 1.3.0 • StudyFlow</p>
          </div>
        </div>
      </div>
    </div>
