    ...
    <div className="max-w-2xl lg:max-w-5xl mx-auto px-6 py-6 pb-24 md:pb-8">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <div className="flex items-center justify-center gap-2 mb-2">
          <Palette className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-500" />
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              size="md"
              className={`flex-1 ${
                hasChanges ? "shadow-lg shadow-emerald-500/30" : ""
              }`}
            >
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ backgroundColor: previewColors.progressBg }}
              >
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: "67%" }}
            ...
            <motion.button
              ...
              style={{
                backgroundColor:
                  previewTheme === "high-contrast" ? "#ffffff" : "#10b981",
