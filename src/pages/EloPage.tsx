          ...
          <p className="text-center text-gray-600 dark:text-gray-400 flex items-center justify-center gap-2">
            {nextElo ? (
              <>
                ...
                XP para <span className="font-bold">{nextElo.name}</span>
              </>
            ) : (
              <>
                <Sparkles
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-emerald-700 dark:text-emerald-300 font-medium">
                  +1 XP por minuto estudado
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Teoria, questões ou revisão - todos contam!
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Questões erradas ou em branco não dão XP
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Incentivo extra para quem estuda por leitura!
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Cada conquista dá XP ao ser resgatada
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-sm sm:text-base text-gray-700 dark:text-gray-300">
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                <span className="block font-medium">
                  1h de estudo + 20 páginas + 10 acertos
                </span>
                <span className="text-emerald-600 dark:text-emerald-400 font-bold text-lg sm:text-base">
                  = 150 XP
                </span>
              </div>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              (60 min × 1) + (20 págs × 2) + (10 acertos × 5) = 150 XP
            </p>
          </div>
        </motion.div>
