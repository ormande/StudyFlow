...
export default function GoalsPage({ logs, onNavigateBack }: GoalsPageProps) {
  ...
  const [isWeeklyQuestionsEditing, setIsWeeklyQuestionsEditing] =
    useState(false);
          ...
          <div className="space-y-6">
            ...
            <div>
                    ...
                    <div>
                      <input
                        ...
                        onBlur={() => {
                          ...
                          if (parsed === null) {
                            addToast(
                              "Formato inválido! Use: 4h30min, 4h ou 4.5",
                              "error"
                            );
                            setDailyInputValue(
                              formatHoursToText(localGoals.dailyTimeGoal)
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                Ajuda na consistência, mas é flexível
              </p>
            ...
            <div>
                    ...
                    <div>
                      <input
                        ...
                        onBlur={() => {
                          ...
                          if (parsed === null) {
                            addToast(
                              "Formato inválido! Use: 25h30min, 25h ou 25.5",
                              "error"
                            );
                            setWeeklyInputValue(
                              formatHoursToText(localGoals.weeklyTimeGoal)
                            ...
                            addToast(
                              "Meta deve estar entre 0h e 168h (7 dias)",
                              "error"
                            );
                            setWeeklyInputValue(
                              formatHoursToText(localGoals.weeklyTimeGoal)
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                Meta principal - permite compensar dias
              </p>
                ...
                <button
                  onClick={() => {
                    if (isDailyQuestionsEditing) {
                      ...
                      setDailyQuestionsInputValue(
                        localGoals.dailyQuestionsGoal.toString()
                      );
                    }
                  ...
                  {!isDailyQuestionsEditing ? (
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) =>
                          setDailyQuestionsInputValue(e.target.value)
                        }
                        onBlur={() => {
                ...
                <button
                  onClick={() => {
                    if (isWeeklyQuestionsEditing) {
                      ...
                      setWeeklyQuestionsInputValue(
                        localGoals.weeklyQuestionsGoal.toString()
                      );
                    }
                  ...
                  {!isWeeklyQuestionsEditing ? (
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) =>
                          setWeeklyQuestionsInputValue(e.target.value)
                        }
                        onBlur={() => {
                          const value =
                            parseInt(weeklyQuestionsInputValue) || 0;
            ...
            <div className="flex flex-col gap-3 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <IOSSwitch
                  ...
                  onChange={(checked) =>
                    updateLocalGoal("settings", { countWeekends: checked })
                  }
            ...
            <div className="flex flex-col gap-3 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <IOSSwitch
                  ...
                  onChange={(checked) =>
                    updateLocalGoal("settings", { strictMode: checked })
                  }
